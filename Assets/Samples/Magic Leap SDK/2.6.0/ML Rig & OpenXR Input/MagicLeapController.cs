...
namespace MagicLeap.Examples
{
    ...
    public class MagicLeapController
    {
        ...
        private readonly InputAction triggerAction, triggerValueAction, touchpadClickAction, touchpadForceAction, bumperAction, menuButtonAction, touchpadAction, positionAction,
        ...
        private MagicLeapController()
        {
            ...
            touchpadClickAction = inputMap.FindAction("TrackpadClick");
            ...
            touchpadAction = inputMap.FindAction("Trackpad");
            touchpadForceAction = inputMap.FindAction("TrackpadForce");
        }
        ...
        /// <summary>
        /// Trigger released/canceled event
        /// </summary>
        ...
        /// <summary>
        /// Touchpad touch position update event
        /// </summary>
        public event Action<InputAction.CallbackContext> Touchpad
        {
            add => touchpadAction.performed += value;
            remove => touchpadAction.performed -= value;
        }

        /// <summary>
        /// Trackpad click event
        /// </summary>
        public event Action<InputAction.CallbackContext> TouchpadClicked
        {
            add => touchpadClickAction.performed += value;
            remove => touchpadClickAction.performed -= value;
        }
        
        /// <summary>
        /// Touchpad force event
        /// </summary>
        public event Action<InputAction.CallbackContext> TouchpadForceApplied
        {
            add => touchpadForceAction.performed += value;
            remove => touchpadForceAction.performed -= value;
        }
        
        /// <summary>
        /// Touchpad force release/cancelled event
        /// </summary>
        public event Action<InputAction.CallbackContext> TouchpadForceCancelled
        {
            add => touchpadForceAction.canceled += value;
            remove => touchpadForceAction.canceled -= value;
        }
        ...
        /// </summary>
        public Vector2 TouchPosition => touchpadAction.ReadValue<Vector2>();

        /// <summary>
        /// The current touch pressure being applied to the controller's touchpad, from 0 to 1.
        /// </summary>
        public float TouchPressure => touchpadForceAction.ReadValue<float>();
    }
}
